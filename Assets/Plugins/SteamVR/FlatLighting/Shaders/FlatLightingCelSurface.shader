Shader "FlatLighting/FlatLightingCelSurface" {
	Properties {
	...
	SubShader {
		Tags { "RenderType"="Opaque" 
				"FlatLightingTag"="FlatLighting/FlatLightingCelSurface"
			}

		LOD 100
		
		CGPROGRAM
		#pragma surface surf ToonRamp vertex:vert addshadow fullforwardshadows
		#pragma target 2.0
	...
	CustomEditor "FlatLightingCelSurfacerEditor"
}
